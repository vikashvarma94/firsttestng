...
public class EngineeringToolsAndEquipments {
WebDriver driver;
	...
	public void extra() throws InterruptedException {
	  Actions a = new Actions(driver);
		...
		a.moveToElement(driver.findElement(By.linkText("Engineering Tools And Equipments"))).perform();
		driver.findElement(By.linkText("Machines And Equipments")).click();
