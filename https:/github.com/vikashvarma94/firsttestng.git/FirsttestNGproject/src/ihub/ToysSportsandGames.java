...
public class ToysSportsandGames {
WebDriver driver;
	...
	public void extra() throws InterruptedException {
	  Actions a = new Actions(driver);
		...
		a.moveToElement(driver.findElement(By.linkText("Toys Sports & Games"))).perform();
		driver.findElement(By.linkText("Ride On joys")).click();
//		Ride On joys
//		Sports
//		Toys
//		Games
