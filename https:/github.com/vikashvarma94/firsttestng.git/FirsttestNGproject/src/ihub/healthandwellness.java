...
public class healthandwellness {
WebDriver driver;
	...
	public void extra() throws InterruptedException {
	  Actions a = new Actions(driver);
		...
		a.moveToElement(driver.findElement(By.linkText("Health And Wellness"))).perform();
		driver.findElement(By.linkText("Health Care Devices")).click();
//		Health Care Devices
//		Braces and Supports
//		OTC & Health Needs
//		Diet & Nutrition
//		Exercise and Fitness
	...
	public void normal() throws InterruptedException {
	  Actions a = new Actions(driver);
		a.moveToElement(driver.findElement(By.xpath("//p[@class=\"no-margin\"]"))).perform();
		a.moveToElement(driver.findElement(By.linkText("Health And Wellness"))).perform();
		driver.findElement(By.linkText("First Aid")).click();
//		First Aid
//		Bed Pan
