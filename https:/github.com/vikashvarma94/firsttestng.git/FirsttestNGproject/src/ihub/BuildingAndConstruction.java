...
public class BuildingAndConstruction {
WebDriver driver;
	...
	public void extra() throws InterruptedException {
	  Actions a = new Actions(driver);
		...
		a.moveToElement(driver.findElement(By.linkText("Building And Construction"))).perform();
		driver.findElement(By.linkText("Paints&Coatings")).click();
//		Paints&Coatings
//		Sanitaryware
//		Taps/Faucets
//		Tiles & Accessories
...
public void normal() throws InterruptedException {
  Actions a = new Actions(driver);
	a.moveToElement(driver.findElement(By.xpath("//p[@class=\"no-margin\"]"))).perform();
	a.moveToElement(driver.findElement(By.linkText("Building And Construction"))).perform();
	driver.findElement(By.linkText("Screws & Nails")).click();
//	Screws & Nails
//	Fencing Wire
//	Bricks and Blocks
//	Cement & Concrete
